...
namespace sleepEditPro
{
    ...
    /// </summary>
    public class SpO2Artifact : Form
    {
        /// <summary>
        ...
        public TextBox textBox_spo2Value;
        ...
        private void InitializeComponent()
        {
            ...
            // textBox_spo2Value
            // 
            this.textBox_spo2Value.Font = new System.Drawing.Font("Microsoft Sans Serif", 12F,
            ...
            this.textBox_spo2Value.Validating +=
                new System.ComponentModel.CancelEventHandler(this.textBox_spo2Value_Validating);
            // 
            // label2
            // 
            ...
            this.okButton.Font = new System.Drawing.Font("Microsoft Sans Serif", 10.2F, System.Drawing.FontStyle.Regular,
                System.Drawing.GraphicsUnit.Point, ((System.Byte) (0)));
        ...
        private void textBox_spo2Value_Validating(object sender, CancelEventArgs e)
        {
            var pattern = @"^[1-9][0-9](\.[0-9])?$";
            var input = textBox_spo2Value.Text;

            var isMatched = Regex.IsMatch(input, pattern);
            if (!isMatched)
            {
