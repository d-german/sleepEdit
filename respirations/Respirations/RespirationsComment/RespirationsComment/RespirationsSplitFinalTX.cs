    ...
    public class RespirationsSplitFinalTX : Respirations
    {
        ...
        protected override void initializeNormalSeverityValues()
        {
            ...
            normalSeverityResults[0] =
                "Overall <CPAP/BIPAP> at <TX> cm H2O effectively controls the patient’s documented sleep apnea/hypopnea. ";

            normalSeverityResults[1] =
                "Overall <CPAP/BIPAP> at <TX> cm H2O effectively controls the patient’s documented sleep apnea/hypopnea with 1 event per hour of sleep. ";

            normalSeverityResults[2] =
                "Overall <CPAP/BIPAP> at <TX> cm H2O effectively controls the patient’s documented sleep apnea/hypopnea with <INDEX> events per hour of sleep. ";

            normalSeverityResults[3] =
                "<CPAP/BIPAP> at <TX> cm H2O controls the patient’s documented sleep apnea/hypopnea. ";

            normalSeverityResults[4] =
                "<CPAP/BIPAP> at <TX> cm H2O controls the patient’s documented sleep apnea/hypopnea. ";

            normalSeverityResults[5] =
                "<CPAP/BIPAP> at <TX> cm H2O effectively controls the patient’s documented sleep apnea/hypopnea with <INDEX> events per hour of sleep. ";
        }
